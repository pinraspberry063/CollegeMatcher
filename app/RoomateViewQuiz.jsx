...
const RoomateViewQuiz = ( { route } ) => {
     ...
     const handleFindRoomateAns = async (roomateUID) =>{
        ...
        console.log(roomateUID);
        console.log(currRoomateSnapshot.docs[0].bedtime);
        console.log(currRoomateSnapshot.docs[0].bedtime == 1);
        console.log(currRoomateSnapshot.docs[0].bedtime == 2);
        console.log(currRoomateSnapshot.docs[0].bedtime == 3);
        console.log(currRoomateSnapshot.docs[0].bedtime == 4);
        console.log(currRoomateSnapshot.docs[0].bedtime == 5);
