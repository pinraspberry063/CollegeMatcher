...
const Quiz = ({navigation}) => {
  ...
  const religiousAffiliationData = [
    {label: 'N/A', value: 'N/A'},
    {
      label: 'American Methodist Episcopal',
      value: 'American Methodist Episcopal',
    },
    {
      label: 'African Methodist Episcopal Zion',
      value: 'African Methodist Episcopal Zion',
    },
    {label: 'American Baptist', value: 'American Baptist'},
    {
      label: 'American Evangelical Lutheran',
      value: 'American Evangelical Lutheran',
    },
    ...
    {
      label: 'Christ and Missionary Alliance',
      value: 'Christ and Missionary Alliance',
    },
    ...
    {
      label: 'Evangelical Free Church of American',
      value: 'Evangelical Free Church of American',
    },
    ...
    {
      label: 'Multiple Protestant Denomination',
      value: 'Multiple Protestant Denomination',
    },
    ...
    {
      label: 'Wisconsin Evangelical Lutheran',
      value: 'Wisconsin Evangelical Lutheran',
    },
  ];
  ...
  const renderPageTwo = () => (
    <View>
      ...
      <Text style={[styles.text, {color: theme.color}]}>
        Are you looking for a school with sporting events?
      </Text>
      <DropdownComponent
        data={[
          {label: 'Yes', value: 'Yes'},
      ...
      <Text style={[styles.text, {color: theme.color}]}>
        Are you looking for a diverse college?
      </Text>
      <DropdownComponent
        data={[
  ...
  const renderPageThree = () => (
    <View>
      ...
      <Text style={[styles.text, {color: theme.color}]}>
        Are you looking for a college in a specific type of area?
      </Text>
      <DropdownComponent
        data={typeOfAreaData}
        value={urbanizationLevel}
        onChange={setTypeOfArea}
      />
