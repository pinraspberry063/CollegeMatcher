---
title: RoomateViewQuiz
---
<SwmSnippet path="/app/RoomateViewQuiz.jsx" line="9">

---

This feature was scrapped due to visual issues and time constraints. Originally, this feature served to allow the user to view their potential roomates quiz choices for a more curated but manually driven selection process.
...
<SwmSnippet path="/app/RoomateViewQuiz.jsx" line="50">

---

Supposed to grab the individual roomates choices for each quiz question and save them into a varible. Currently does not detect the answers as they are appearing as unkown instead of an integer.
...
<SwmSnippet path="/app/RoomateViewQuiz.jsx" line="291">

---

Formats the page by listing each of the questions from the RoomateMatcher, followed by the response of the idividual roomate that the user is observing.
